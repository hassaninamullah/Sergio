                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-12">
                        <div class="card card-primary mt-5">
                            ...
                            $sql_select = "SELECT id,emp_id,emp_question_set_name,emp_question_description,emp_logo_file,company_name,visit_no FROM  tbl_individual_emp_question_set_master WHERE id = $jms_id";
                            $result_select = mysqli_query($conn, $sql_select);
                            $data = mysqli_fetch_array($result_select);
                            $description = json_decode($data['emp_question_description'], true);
                            /*print_r($description);*/
                            ?>
                            <!-- /.card-header -->
                            <!-- form start -->
                                                                    ...
                                                                    <div class="dynamicField my-1">
                                                                        ...
                                                                        ?>
                                                                                <div class="form-check ml-20">
                                                                                    <input class="form-check-input field_value responseType" data-value="mcqs" type="radio" name="responseTypeFields_<?php echo $count ?>" id="responseTypeFields_<?php echo $count ?>_<?php echo $optionsCount ?>" value="<?php echo $option ?>">
