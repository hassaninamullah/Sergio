                        ...
                        <div class="card card-primary mt-5">
                            <div class="card-header">
                                ...
                                <?php
                                    ...
                                    // $id = $_GET['id'];                   
                                    $sql_select = "SELECT emp_data.id as uid ,emp_data.first_name,emp_data.last_name,emp_data.email_id, question_set.id as question_set_id,question_set.question_set_name,question_set.question_description,answer_set.id,answer_set.question_id,answer_set.users_id,answer_set.answer,file_data,answer_set.emp_location as emp_location FROM  tbl_employee_master emp_data
                                    RIGHT JOIN tbl_answer_set_master answer_set on answer_set.users_id = emp_data.id 
                                    RIGHT JOIN tbl_question_set_master question_set on question_set.id = answer_set.question_id
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                               ...
                                               <td> 
                                                    <a href="view_answers.php?id=<?php echo $data["question_set_id"].'&uid='.$data['uid'].'&primary_id='.$data['id'] ; ?>">
