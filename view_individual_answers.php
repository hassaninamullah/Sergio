...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM tbl_individual_emp_answer_set_master where id = $primary_id and users_id = $jms_users_id";
    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid">
                ...
                $sql_select = "SELECT emp_date.id as user_id,emp_date.first_name as first_name,emp_date.last_name as last_name,email_id,emp_question_set_name,emp_logo_file,emp_question_description,answer,answer_in_detail,file_data,emp_location,manager,answer.visit_no as visit_no,company_name,start_time,end_time,answer.question_id as answer_id,answer.id as primary_id FROM tbl_individual_emp_answer_set_master answer LEFT JOIN tbl_individual_emp_question_set_master question on question.id = answer.question_id RIGHT JOIN tbl_employee_master emp_date on answer.users_id = emp_date.id WHERE answer.id = $primary_id and users_id = $jms_emp_id";
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-8">
                        <p class="kfc-inspection poppins text-center"><?php echo $data['emp_question_set_name'] ?></p>
                    </div>
                    <div class="col-md-2">
                        <img class="w-100" src="img/<?php echo $data['emp_logo_file'] ?>" alt="">
                    </div>
                </div>
                <div class="row">
                                        ...
                                        <form method="POST" name="jms_generate_pdf" id="jms_generate_pdf" enctype="multipart/form-data">
                                            <div class="card-body">
                                                ...
                                                <div class="card-footer">
                                                    <a href="view_individual_questions_answers_list.php" class="btn btn-primary">Back</a>
                                                    <button type="submit" class="btn btn-primary">Generate PDF</button>
                                                    <input type="hidden" value="<?php echo $data['answer_id']; ?>" id="jms_answer_id" name="jms_answer_id">
                                                    <input type="hidden" value="<?php echo $primary_id; ?>" id="primary_id" name="primary_id">
    ...
    <script>
        $(function() {
            $("#jms_generate_pdf").on('submit', function(e) {
                // $("#jms_chart_id").val(myChart.toBase64Image());
                // console.log(myChart.toBase64Image());
                e.preventDefault();
                $.ajax({
                    url: "generate_individual_employee_pdf.php",
                    type: "POST",
                        ...
                        if (data.status == 'error') {
                            ...
                            xhr.onload = function() {
                                if (xhr.status === 200) {
                                    ...
                                    link.href = urlObj;
                                    link.download = 'individual-employee-ques-ans-app.pdf';
