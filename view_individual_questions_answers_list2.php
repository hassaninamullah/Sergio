                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < count($kk_2); $i++) {
                                            ...
                                            while ($select_row = mysqli_fetch_assoc($select_query)) {
                                                $jms_s_name = $select_row['emp_question_set_name'];
                                                $jms_s_name_2 = json_decode($select_row['emp_question_description'], true);

                                                for ($x = 0; $x < count($jms_s_name_2); $x++) {
                                        ?>
                                                    <tr>
                                                        <td><?php echo $emp_new_id_create; ?></td>
                                                        <td><?php echo $jms_s_name; ?></td>
                                                        <!-- <td><?php //echo $jms_s_name_2[$x]; ?></td> -->
                                                        <td>
                                                            <?php
