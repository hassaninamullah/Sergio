...
$sql = "INSERT INTO tbl_answer_set_master (users_id,question_id,answer,answer_in_detail,file_data,emp_location,manager) VALUES ('$jms_emp_id','$jms_question_id','$jms_radio_yes_no','$jms_answer_in_detail','$jms_file_data','$jms_emp_location','$jms_manager')";
